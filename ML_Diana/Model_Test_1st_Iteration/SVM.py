...
#    Stratified 10-Fold CV  |  RBF Kernel
# ============================================================
print("\n" + "=" * 65)
print("9. HYPERPARAMETER TUNING - RandomizedSearchCV (RBF Kernel SVM)")
print("=" * 65)

param_dist = {
    'C':             loguniform(1e-2, 1e3),
    'gamma':         ['scale', 'auto'] + list(loguniform(1e-4, 1e1).rvs(20,
...
def evaluate(model, X_data, y_data, set_name):
    print(f"\n{'=' * 65}")
    print(f"Support Vector Machine - EVALUATION - {set_name}")
    print(f"{'=' * 65}")
...
# ============================================================
print("\n" + "=" * 65)
print("11. Support Vector Machine - TEST SET (Final Model Performance)")
print("=" * 65)

n_sv = best_svc.n_support_
print(f"\nRBF Kernel SVM trained with C = {best_svc.C:.6f}, gamma = {best_svc.gamma}")
...
# ============================================================
print("\n" + "=" * 65)
print("12. Support Vector Machine - FINAL SUMMARY")
print("=" * 65)
