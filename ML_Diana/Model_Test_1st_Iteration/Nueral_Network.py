...
#    Stratified 10-Fold CV  |  MLPClassifier
# ============================================================
print("\n" + "=" * 65)
print("9. HYPERPARAMETER TUNING - RandomizedSearchCV (Neural Network)")
print("=" * 65)
...
mlp_base = MLPClassifier(random_state=RANDOM_STATE)
...
def evaluate(model, X_data, y_data, set_name):
    print(f"\n{'=' * 65}")
    print(f"Neural Network - zEVALUATION - {set_name}")
    print(f"{'=' * 65}")
...
# ============================================================
val_metrics = evaluate(best_mlp, X_val_sc, y_val, "Validation Set")

# ============================================================
# 11. TEST SET EVALUATION
# ============================================================
print("\n" + "=" * 65)
print("11. Neural Network - TEST SET (Final Model Performance)")
print("=" * 65)

arch = best_mlp.hidden_layer_sizes
n_layers = best_mlp.n_layers_
print(f"\nNeural Network Architecture:")
print(f"  Hidden layers   : {arch}")
print(f"  Total layers    : {n_layers}  (input + {n_layers - 2} hidden + output)")
print(f"  Activation      : {best_mlp.activation}")
print(f"  Solver          : {best_mlp.solver}")
print(f"  Training epochs : {best_mlp.n_iter_}")
print(f"  Final loss      : {best_mlp.loss_:.6f}\n")

test_metrics = evaluate(best_mlp, X_test_sc, y_test, "Test Set")

# ============================================================
# 12. FINAL SUMMARY TABLE
# ============================================================
print("\n" + "=" * 65)
print("12. Neural Network - FINAL SUMMARY")
print("=" * 65)
