...
#    Stratified 10-Fold CV  |  K-Nearest Neighbors
# ============================================================
print("\n" + "=" * 65)
print("9. HYPERPARAMETER TUNING - RandomizedSearchCV (KNN)")
print("=" * 65)
...
param_dist = {
    ...
    'p':            [1, 2, 3, 4, 5],              # Minkowski exponent
...
def evaluate(model, X_data, y_data, set_name):
    print(f"\n{'=' * 65}")
    print(f"K-Nearest Neighbors - EVALUATION - {set_name}")
    print(f"{'=' * 65}")
...
# ============================================================
val_metrics = evaluate(best_knn, X_val_sc, y_val, "Validation Set")

# ============================================================
# 11. TEST SET EVALUATION
# ============================================================
print("\n" + "=" * 65)
print("11. K-Nearest Neighbors - TEST SET (Final Model Performance)")
print("=" * 65)

print(f"\nK-Nearest Neighbors with K = {best_knn.n_neighbors}")
print(f"  Weight function : {best_knn.weights}")
print(f"  Distance metric : {best_knn.metric}")
print(f"  Minkowski p     : {best_knn.p}")
print(f"  Leaf size       : {best_knn.leaf_size}")
print(f"  Algorithm       : {best_knn.algorithm}")
print(f"  Training samples stored: {best_knn.n_samples_fit_}\n")

test_metrics = evaluate(best_knn, X_test_sc, y_test, "Test Set")

# ============================================================
# 12. FINAL SUMMARY TABLE
# ============================================================
print("\n" + "=" * 65)
print("12. K-Nearest Neighbors - FINAL SUMMARY")
print("=" * 65)
