...
def evaluate(model, X_data, y_data, set_name):
    ...
    print(f"\n{'=' * 65}")
    print(f"Logistic Regression - EVALUATION - {set_name}")
    print(f"{'=' * 65}")
...
# ============================================================
val_metrics = evaluate(best_lr, X_val_sc, y_val, "Validation Set")

# ============================================================
# 11. TEST SET EVALUATION
# ============================================================
print("\n" + "=" * 65)
print("11. Logistic Regression - TEST SET (Final Model Performance)")
print("=" * 65)

print(f"\nLogistic Regression uses multinomial classification with the")
print(f"'{best_lr.solver}' solver and '{best_lr.penalty}' regularisation.")
print(f"Regularisation strength C = {best_lr.C:.6f}\n")

# Full evaluation on the held-out test set
test_metrics = evaluate(best_lr, X_test_sc, y_test, "Test Set")

# ============================================================
# 12. FINAL SUMMARY TABLE
# ============================================================
print("\n" + "=" * 65)
print("12. Logistic Regression - FINAL SUMMARY")
print("=" * 65)
