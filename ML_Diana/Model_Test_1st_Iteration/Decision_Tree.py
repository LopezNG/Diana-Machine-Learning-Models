...
#    Stratified 10-Fold CV  |  Decision Tree
# ============================================================
print("\n" + "=" * 65)
print("9. HYPERPARAMETER TUNING - RandomizedSearchCV (Decision Tree)")
print("=" * 65)
...
def evaluate(model, X_data, y_data, set_name):
    print(f"\n{'=' * 65}")
    print(f"Decision Tree - EVALUATION - {set_name}")
    print(f"{'=' * 65}")
...
# ============================================================
val_metrics = evaluate(best_dt, X_val_sc, y_val, "Validation Set")

# ============================================================
# 11. TEST SET EVALUATION
# ============================================================
print("\n" + "=" * 65)
print("11. Decision Tree - TEST SET (Final Model Performance)")
print("=" * 65)

print(f"\nDecision Tree Structure:")
print(f"  Criterion       : {best_dt.criterion}")
print(f"  Max depth (set) : {best_dt.max_depth}")
print(f"  Actual depth    : {best_dt.get_depth()}")
...
test_metrics = evaluate(best_dt, X_test_sc, y_test, "Test Set")

# ============================================================
# 12. FINAL SUMMARY TABLE
# ============================================================
print("\n" + "=" * 65)
print("12. Decision Tree - FINAL SUMMARY")
print("=" * 65)
